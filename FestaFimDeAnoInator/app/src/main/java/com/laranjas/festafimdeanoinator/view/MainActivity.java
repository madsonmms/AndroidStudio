...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.mViewHolder.buttonResetTest = findViewById(R.id.button_resetTest);

        this.mViewHolder.buttonConfirm.setOnClickListener(this);
        this.mViewHolder.buttonResetTest.setOnClickListener(this);
    ...
    private void verifyPresence() {
        ...
        String presence = mSecurityPreferences.getStorageString(FimDeAnoConstant.PRESENCE_KEY);
    ...
    private int getDaysLeft() {
        ...
        int daysMax = calendarLastDay.getActualMaximum(Calendar.DAY_OF_YEAR);

        return daysMax - today;
    }
